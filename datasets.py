...
class WangDataset():
    ...
    def unzip_data(self):
        ...
        # Unzip data if original_data does not exist
            ...
            for i in tqdm(range(len(classes_paths))):
                ...
                # Exclude chol category which is said to be discarted in original paper but is in the downloaded data
    ...
    def read_data(self):
        ...
        if not os.path.exists(os.path.join(self.path, 'processed_data')):
            ...
            # Put gene at the beginning column and resetting index to save in feather
