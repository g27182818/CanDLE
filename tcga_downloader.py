"""
This code was taken from https://github.com/vappiah/DataMiner which has complete authorship of the downloader which is
thoroughly explained and documented in the following tutorial:
https://www.youtube.com/watch?v=YJxcsm4aJXI&ab_channel=BioinformaticsCoach
"""
...
def download_data(metadatafile, sep='\t', outdir='downloads'):
    ...
    sampletypes = ['cases.0.samples.0.sample_type'].unique()
    ...
    for sampletype in sampletypes:
        sel = data_df[data_df['cases.0.samples.0.sample_type'].str.contains(sampletype)][['file_id', 'file_name']]
